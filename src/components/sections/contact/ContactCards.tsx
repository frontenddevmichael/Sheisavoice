    ...
    <SectionWrapper className="relative bg-surface-lowest py-space-5xl overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col gap-space-2xl">
          ...
          <div className="bg-primary rounded-card-lg p-space-2xl lg:p-space-3xl text-center relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center gap-space-lg">
              ...
              <WordReveal
                ...
                as="h3"
                className="font-headline text-headline-lg text-on-primary"
                staggerDelay={0.06}
              />
        ...
        <StaggerGrid className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-space-xl">
          {contacts.map((item) => (
            <Card key={item.label} className="flex flex-col gap-space-md pressable h-full">
        ...
        {/* Safeguarding Banner — scale blur */}
