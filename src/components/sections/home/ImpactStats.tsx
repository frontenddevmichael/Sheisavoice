            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-space-xl items-center">
              ...
              <div className="lg:col-span-5 flex flex-col gap-space-md">
                ...
                <div className="flex items-baseline gap-space-sm pt-space-xs">
                  <CountUp
                    to={IMPACT_STATS.childrenCount}
                    duration={2}
                    delay={0.4}
                    className="font-headline text-headline-xl font-bold text-primary leading-none tracking-tighter"
                  />
              ...
              <div className="lg:col-span-7 flex flex-col gap-space-md bg-surface-lowest p-space-lg lg:p-space-xl rounded-card-md shadow-sm">
                ...
                <div className="flex flex-col gap-space-sm pt-space-xs">
                  {IMPACT_STATS.therapyPlacements.map((item, i) => {
                    const barColor =
                      item.color === "primary"
